...
const SampleReviewForm = ({ sample, onFinish }: SampleReviewFormProps) => {
    ...
    useEffect(() => {
        ...
        if (watchStatusChange === "Autorizado") {
            message = "Prezado(a) Pesquisador(a), Informamos que uma nova pesquisa foi liberada e já está disponível para preenchimento na plataforma SuperDot. Sua participação é essencial para a identificação da população com altas habilidades/superdotação e contribui diretamente para o aprimoramento dos dados do Censo Escolar Brasileiro. Agradecemos, desde já, sua valiosa colaboração!";
